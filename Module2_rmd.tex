...
\subsection{This is a level 2 header}\label{this-is-a-level-2-header}

\subsubsection{This is a level 3 header}\label{this-is-a-level-3-header}

\paragraph{This is level 4 header}\label{this-is-level-4-header}
...
\includegraphics{Module2_rmd_files/figure-latex/pressure-1.pdf}
\includegraphics{Module2_rmd_files/figure-latex/pressure2-1.pdf} \#\#
Insert Tables

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\SpecialCharTok{::}\FunctionTok{kable}\NormalTok{(}\FunctionTok{head}\NormalTok{(cars), }
             \AttributeTok{caption =} \StringTok{"Top 6 rows of cars of Dataset"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}rr@{}}
\caption{Top 6 rows of cars of Dataset}\tabularnewline
\toprule\noalign{}
speed & dist \\
\midrule\noalign{}
\endfirsthead
